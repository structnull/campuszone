...
class EventDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
        // We use Stack manually for the Hero image effect, so we might skip standard AppAppBar or put it on top transparently
        extendBodyBehindAppBar: true,
        backgroundColor: AppColors.scaffoldBackground,
        // No standard appBar param here, we build it custom or use transparency
        appBar: AppAppBar(
          backgroundColor: Colors.transparent,
          showBackButton: true,
          iconTheme: IconThemeData(
              color: AppColors
                  .black), // Black on top of potentially white UI or image?
          // Original had a back button circle avatar.
          // We'll trust AppAppBar transparency or replicate the design.
          // Let's implement body.
        ),
        body: Stack(
          children: [
            if (imageUrl != null)
