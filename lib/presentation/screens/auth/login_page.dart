...
class _LoginPageState extends State<LoginPage>
  ...
  final _cooldown = Cooldown(duration: const Duration(seconds: 3));
  ...
  Future<void> _signIn() async {
    ...
    if (!_cooldown.canRun) {
      _showSnackBar('Please wait before trying again');
      return;
    }
    _cooldown.trigger();
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FormField<String>(
                      validator: (_) =>
                          Validators.required(_emailController.text),
                    ...
                    FormField<String>(
                      validator: (_) =>
                          Validators.required(_passwordController.text),
                      builder: (state) => Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(
